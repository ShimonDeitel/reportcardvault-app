...
struct SettingsView: View {
    ...
    @AppStorage("reportcardvault_notifyEnabled") private var notifyEnabled = true
    @AppStorage("reportcardvault_iCloudSyncEnabled") private var iCloudSyncEnabled = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/reportcardvault-app/privacy.html")!)
                    Text("Version 1.0")
